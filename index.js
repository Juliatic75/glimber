    ...
    // Пауза при наведении
    document.querySelector('.photo-slider').addEventListener('mouseenter', stopSlideShow);
    document.querySelector('.photo-slider').addEventListener('mouseleave', startSlideShow);
